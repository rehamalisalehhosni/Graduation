        ...
        foreach ($discussions as $discussion) {
            ...
            <tr >
                ...
                <td>
                    ...
                    <a href="{{ Request::root() }}/backend/discussion/destroy/{{ $discussion->discussion_id }}" class="btn btn-danger" role="button" > Delete </a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
</table>
<?php echo $discussions->appends(['search' => $keyword])->render(); ?>
@show
